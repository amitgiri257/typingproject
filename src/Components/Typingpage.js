...
const Typingpage=(props)=>{
    ...
    let displaytext="positive course impossible carried come tropical adventure movement goes white wide explanation danger toward repeat fish wear next tight tea share high familiar surface ability is courage parent average jet crack force weigh toy mail daily variety wood mark apartment us climb compass silk pass few bag ever these hollow";
    ...
    return(
        ...
        <div className="btn-container">
            ...
            <button className="bottom-btn" >10</button>
            <button className="bottom-btn">50</button>
            <button className="bottom-btn" >80</button>
            <button className="bottom-btn" >100</button>
            <span className="bottom-span">-</span>
